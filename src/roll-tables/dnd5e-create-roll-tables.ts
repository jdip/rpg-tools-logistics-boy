import { dnd5eItemGroupTests } from './dnd5e-item-groupings'
...
const dnd5eCreateRollTables = async (
  tables: string[],
  ...
  for (let i = 0; i < tables.length; i = i + 1) {
    ...
    const testData = dnd5eItemGroupTests.find(t => t.title === table) as ItemGroupTest
