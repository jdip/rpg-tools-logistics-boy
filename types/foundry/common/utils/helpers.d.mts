import { DataModel } from "../abstract/data";
import { RawObject } from "../abstract/data";
 ...
 * @param original Some sort of data
 */
export function duplicate<T extends DataModel>(original: T): RawObject<T>;
 ...
 */
export function flattenObject(obj: {}, _d?: number): Record<string, unknown>;
